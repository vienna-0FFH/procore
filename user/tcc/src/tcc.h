...
/* uCore supplies a freestanding user ABI.  The compiler still targets i386,
 * but it is not a host executable and must not enable TinyCC's -run path. */
#ifdef UCORE_TCC
# undef TCC_IS_NATIVE
# undef TCC_TARGET_UNIX
#endif
