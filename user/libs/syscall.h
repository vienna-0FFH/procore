...
int sys_pread(int fd, void *base, size_t len, off_t offset);
int sys_pwrite(int fd, const void *base, size_t len, off_t offset);
int sys_readv(int fd, const struct iovec *iov, size_t count);
int sys_writev(int fd, const struct iovec *iov, size_t count);
